<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Admin_Secure_design_Page_Delete" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
    ...
    <p>Please confirm if you want to delete the page named <b>"<% = PageName%>"</b>. Note that this change cannot be undone.</p>
