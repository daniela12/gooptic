<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="add_attribute.aspx.cs" Inherits="Admin_Secure_catalog_product_Attribute_Types_add_attribute" %>
