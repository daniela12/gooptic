<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierTypeList.aspx.cs" Inherits="Admin_Secure_settings_RuleTypes_SupplierTypeList" MasterPageFile="~/Admin/Themes/Standard/content.master" %>
...
<div class="Form">
    <table cellspacing="0" cellpadding="0" width="100%">
		    <tr>
			    <td><h1>Custom .NET Supplier Classes</h1></td>
			    <td align="right">
			        <asp:button CssClass="Button" id="btnAddRuleType" CausesValidation="False" Text="Add a New Supplier Rule Type" Runat="server" onclick="btnAddRuleType_Click"></asp:button>
    ...
    <h4>.NET Supplier Class List</h4>    
    <asp:GridView ID="uxGrid" runat="server" CssClass="Grid" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="uxGrid_PageIndexChanging" CaptionAlign="Left" OnRowCommand="uxGrid_RowCommand" Width="100%" AllowSorting="True" EmptyDataText="No tax rule types available to display." OnRowDeleting="uxGrid_RowDeleting" OnRowEditing="uxGrid_RowEditing">
        <Columns>
            <asp:BoundField DataField="SupplierTypeId" HeaderText="ID" />
