<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxRuleList.aspx.cs" Inherits="Admin_Secure_settings_RuleTypes_TaxRuleList" MasterPageFile="~/Admin/Themes/Standard/content.master" %>
...
<div class="Form">
    <table cellspacing="0" cellpadding="0" width="100%">
		    <tr>
			    <td><h1>Custom .NET Tax Classes</h1></td>
			    <td align="right">
			        <asp:button CssClass="Button" id="btnAddRuleType" CausesValidation="False" Text="Add a New Tax Rule Type" Runat="server" onclick="btnAddRuleType_Click"></asp:button>
    ...
    <asp:GridView ID="uxGrid" runat="server" CssClass="Grid" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="uxGrid_PageIndexChanging" CaptionAlign="Left" OnRowCommand="uxGrid_RowCommand" Width="100%" AllowSorting="True" EmptyDataText="No tax rule types available to display." OnRowDeleting="uxGrid_RowDeleting" OnRowEditing="uxGrid_RowEditing">
        <Columns>
            <asp:BoundField DataField="TaxRuleTypeId" HeaderText="ID" />
