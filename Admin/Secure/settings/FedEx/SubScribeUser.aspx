<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="SubScribeUser.aspx.cs" Inherits="Admin_Secure_settings_FedEx_SubScribeUser" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="uxMainContent">
    <div class="Form">        
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td>
                    <h1>FedEx Meter Number Request</h1>
        ...
        <div><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="* Enter Phone Number" ControlToValidate="PhoneNumber" CssClass="Error" Display="Dynamic"></asp:RequiredFieldValidator></div>
