<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/Report.master"  AutoEventWireup="true" CodeFile="InventoryReports.aspx.cs" Inherits="Admin_Secure_Reports_InventoryReports" %>
...
<table width="100%">
    <tr>
        <td>
            ...
            <table>            
            <tr>             
                <td><div class="ReportStyle">Get orders for the last</div></td>                         
                <td> 
    ...
    <rsweb:ReportViewer ID="objReportViewer" runat="server" Width="100%" Font-Names="Verdana" Font-Size="8pt">   
        <LocalReport DisplayName="Report" ReportPath="inventory.rdlc">               
        </LocalReport>
    </rsweb:ReportViewer>
