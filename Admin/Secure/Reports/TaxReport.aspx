<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/Report.master" AutoEventWireup="true" CodeFile="TaxReport.aspx.cs" Inherits="Admin_Secure_Reports_TaxReport" %>
...
<div class="Form">
    ...
    <tr>
        <td>
            ...
            <div><uc1:spacer id="Spacer2" SpacerHeight="5" SpacerWidth="3" runat="server"></uc1:spacer></div>                     
              <table width="80%">        
            <tr>
                <td><div class="FieldStyle">Begin Date (MM/DD/YYYY)
                </div>
                </td>
                <td><div class="FieldStyle">End Date (MM/DD/YYYY)</div>
                </td>
                </tr>       
            <tr>   
            ...
            <tr>
            <td>&nbsp;</td>
            <td><asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtStartDate" ValidationGroup="grpReports"
    ...
    <rsweb:ReportViewer ID="objReportViewer" runat="server" Width="100%" Font-Names="Verdana" Font-Size="8pt">
        <LocalReport DisplayName="Report"></LocalReport>
    </rsweb:ReportViewer>
