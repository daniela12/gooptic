<%@ Page Language="C#" MasterPageFile="~/Admin/Themes/Standard/edit.master" AutoEventWireup="true" CodeFile="note_add.aspx.cs" Inherits="Admin_Secure_sales_customers_Note_Add" Title="Untitled Page"  ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="uxMainContent" Runat="Server">
     ...
     <div class="Form">
        ...
        <div class="ValueStyle"><asp:TextBox ID='txtNoteTitle' runat='server' MaxLength="50" Columns="50"></asp:TextBox>
